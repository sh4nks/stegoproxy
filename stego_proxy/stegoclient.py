...
class ProxyHandler(BaseHTTPRequestHandler):
    ...
    def _connect_to_host(self):
        ...
        # Now that we got the hostname and port of the destination
        # we put that in a stego packet
        server_addr = f"{self.hostname}:{self.port}"
        stego_packet = encoder.encode(to_bytes(server_addr))
        # log.info(stego_packet)
